...
namespace Modules
{
    ...
    class References
    {
        ...
        /// <summary>
        /// A list of names a star may be given randomly, provided by Chat-GPT.
        /// </summary>
        static public string[] StarNames = new string[]
        {
            "Lumaraon",
            "Celestriax",
            "Quasaris",
        ...
        /// <summary>
        /// A list of names a planet may be given randomly, provided by Chat-GPT.
        /// </summary>
        static public string[] PlanetNames = new string[]
        {
            "Terravon",
            "Aquaria",
            "Pyronis",
